...
.center[
###As we can see in the graph to the left, hanging out with friends does not have a relationship with academic stress. I believe that this is caused by a combination of all three factors mentioned in the previous slide.
]
]]

---

class: class: split-40 hide-slide-number with-thick-border
.column.bg-main8[.content.center.vmiddle[
###How about time spent exercising each day? Well it has been proven that exercising helps alleviate [mental stress](https://www.health.harvard.edu/staying-healthy/exercising-to-relax)
...
.row[.content.center[
<br>
###1. Well it has been proven that exercising helps alleviate stress
]]
